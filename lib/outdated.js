...
||||||| parent of de80f6d... Move modules to new standard formatting in preparation for rewrites
    if (er) return cb()
    if (!d || !d["dist-tags"] || !d.versions) return cb()
    var l = d.versions[d["dist-tags"].latest]
=======
    ...
    if (!d || !d['dist-tags'] || !d.versions) return cb()
    var l = d.versions[d['dist-tags'].latest]
>>>>>>> de80f6d... Move modules to new standard formatting in preparation for rewrites
    if (!l) return cb()
